    ...
    def generate_chronicle_ai(self, records: List[Dict[str, Any]]) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            prompt = (
                ...
                "       - \"detectedComposer\": composer name (e.g., \"Camille Saint-Saëns\", \"Hector Berlioz\", \"Johann Sebastian Bach\", \"Ludwig van Beethoven\", \"Antonín Dvořák\", \"Pyotr Ilyich Tchaikovsky\")\n"
                "       - \"eraName\": era name\n"
                "       - \"aiInsight\": a 1-sentence audiophile/musicological insight on why this piece or recording is notable.\n\n"
                "3. Provide a complete, detailed \"composerStats\" list dynamically extracting EVERY classical composer represented across the collection records (e.g. Camille Saint-Saëns, Hector Berlioz, Felix Mendelssohn, Robert Schumann, Franz Liszt, Jean Sibelius, Gustav Mahler, etc.). Order chronologically by composer birth year. For each composer:\n"
